...
func (t Token) EndOfToken(src []byte) int {
	...
	case Add, Sub, And, Star, Div, LParen, RParen, LBrace, RBrace, Lt, Gt, Semicolon, Assign, Comma:
		eot++ // For single character tokens (like '+', '-', etc.)
	case Eq, Ne, Le, Ge, Define:
